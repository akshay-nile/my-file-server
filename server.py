...
def welcome():
    ...
    return render_template('welcome.html', drives=drives, meta=gethostname(), libraries=libs, shortcuts=shorts)
...
def home():
    ...
    if os.path.isdir(path):
        return render_template('index.html', meta=path.replace('\\', '/').replace('/', ' / '))
